...
export default function App() {
  ...
  // Add product form
  const [newProduct, setNewProduct] = useState({ name: "", brand: "", company: "", category: "", unit: "1 pc", costPrice: "", mrp: "", sellPrice: "", stock: "", minLevel: "", barcode: "", image: null, dateAdded: new Date().toISOString().slice(0,10) });
  ...
  const addProduct = () => {
    ...
    setNewProduct({ name: "", brand: "", company: "", category: "", unit: "1 pc", costPrice: "", mrp: "", sellPrice: "", stock: "", minLevel: "", barcode: "", image: null, dateAdded: new Date().toISOString().slice(0,10) });
