          ...
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.88)",zIndex:2000,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
            <div style={{background:T.card,borderRadius:"24px 24px 0 0",padding:"20px 20px 40px",width:"100%",maxWidth:430,maxHeight:"92vh",overflowY:"auto"}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:18}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  <div style={{fontWeight:800,fontSize:18,lineHeight:1.2}}>{p.name}</div>
                  <div style={{fontSize:12,color:T.muted,marginTop:2}}>{p.company||p.brand} · {p.unit}</div>
              ...
              {/* Date & Time */}
              <div style={{background:T.bg,borderRadius:12,padding:"10px 14px",marginBottom:16,display:"flex",alignItems:"center",gap:10}}>
                <span style={{fontSize:18}}>🕐</span>
                <div>
                  <div style={{fontWeight:700,fontSize:14,color:T.text}}>{dateStr}</div>
                  <div style={{fontSize:12,color:T.muted}}>Time: {timeStr} · Sale will be logged automatically</div>
                </div>
              </div>
                  ...
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                        ...
                        <button onClick={() => openEdit(p)} style={{ flex: 1, background: `${T.accent}18`, border: `1px solid ${T.accent}40`, borderRadius: 10, padding: "10px 8px", color: T.accent, fontWeight: 700, fontSize: 12, cursor: "pointer" }}>✏</button>
                        {(st === "low" || st === "empty") && (
