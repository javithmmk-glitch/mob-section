...
export default function App() {
  ...
  // Called after addProduct() to show the newly added product in POS view
  const showJustAdded = useCallback((addedProduct) => {
    setPosQtyAdj(1);
  ...
  const addProduct = () => {
    ...
    const addedProduct = { id, ...newProduct, costPrice: parseFloat(costPrice), mrp: parseFloat(mrp), sellPrice: parseFloat(sellPrice), stock: parseInt(stock), minLevel: parseInt(minLevel), unitsSoldMonthly: parseFloat(newProduct.unitsSoldMonthly) || 0, lastOrdered: 0 };
    ...
    // Show the newly added product in POS card view so user can verify it
